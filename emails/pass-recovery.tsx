...
export const PassRecovery = ({ firstName, token, email }: PassRecoveryProps) => (
  <Html>
    <Head>
      <style>
        {`
      ...
      <Body>
        ...
        <Container style={main} className="mx-auto">
          ...
          <Section className='px-[20px]'>
            <Section className=''>
              <Text className="text-[14px] text-[#171717]" style={{ fontFamily: 'Geist, sans-serif' }}>
                Olá {firstName},
              </Text>
              <Text className="text-[14px] text-[#171717] leading-[150%] mb-0" style={{ fontFamily: 'Geist, sans-serif' }}>
                Recebemos um pedido para redefinir a palavra-passe da sua conta no Backoffice da Motorlione.
                <br /> Para continuar o processo de recuperação da palavra-passe, clique no botão abaixo.
              </Text>
            </Section>
              ...
              <Row>
                <Column align='center'>
                  <Button
                    ...
                    href={`${baseUrl}/auth/reset-password?token=${token}&email=${encodeURIComponent(email)}`}
            ...
            <Section className='mt-[48px]'>
              <Text className="text-[14px] text-[#171717] leading-[150%] m-0" style={{ fontFamily: 'Geist, sans-serif' }}>
                Se não foi você quem fez este pedido, por favor ignore este email. Nenhuma alteração será feita à sua conta sem a sua confirmação.
              </Text>
...
PassRecovery.PreviewProps = {
  firstName: 'Paula',
  token: generateRandomToken(16),
  email: 'paula@example.com',
} as PassRecoveryProps;
